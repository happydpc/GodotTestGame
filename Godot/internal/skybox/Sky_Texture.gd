...
func set_time_of_day(hours, directional_light, horizontal_angle = 0.0):
	var sun_pos = Vector3(0.0, -100.0, 0.0)
	sun_pos = sun_pos.rotated(Vector3(1.0, 0.0, 0.0), hours * PI / 12.0)
	sun_pos = sun_pos.rotated(Vector3(0.0, 1.0, 0.0), horizontal_angle)
