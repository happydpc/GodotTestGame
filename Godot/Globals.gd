...
var audio_clips = {
	"pistol_shot":preload("res://assets/Arrow.wav"),
	"rifle_shot":preload("res://assets/Explosion.wav"),
	"gun_cock":preload("res://assets/Reload.wav")
}
...
func load_new_scene(new_scene_path):
	...
	# Change scenes
	var _err = get_tree().change_scene(new_scene_path)
